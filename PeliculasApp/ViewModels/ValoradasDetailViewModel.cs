...
{
    public partial class ValoradasDetailViewModel : ObservableObject, IQueryAttributable
    {
        private readonly PeliculaDbContext _dbContext;
        private const string URLIMAGE = "https://image.tmdb.org/t/p/w500";

        [ObservableProperty]
        private ValoratedMovieDTO peliculaDto = new();
        ...
        public ValoradasDetailViewModel(PeliculaDbContext context)
        {
            _dbContext = context;
        }
        ...
        public async void ApplyQueryAttributes(IDictionary<string, object> query)
        {
            ...
            {
                var encontrado = await _dbContext.ValoratedMovies.FirstAsync(e => e.Id == IdPelicula);
